...
class EnqueueCrefs extends ControlerCrefs
{
	...
	public function enqueue(){
        ...
        if(comments_open() === false || $is_allowed !== 'on') {
        ...
        $user = (get_current_user_id()) ? get_current_user_id() : '';
        $user_email = (get_the_author_meta('email', $user)) ? get_the_author_meta('email', $user) : '';
        ...
        $settings['website']    =   (get_the_author_meta('user_url', $user)) ? get_the_author_meta('user_url', $user) : '';
        ...
        $settings['comments']   =   (get_comments(array('author_email' => $user_email, 'count' => true))) ? get_comments(array('author_email' => $user_email, 'count' => true)) : 0;
